...
// Ensambla las dos paginas para Claude Design a partir de las mismas fuentes
// que alimentan la vista previa: una sola hoja de estilos, un solo cuerpo,
// una sola logica. Ejecutar tras cualquier cambio en estilos.css.
const fs = require('fs');
...
/* Enlaces entre archivos. Los testigos se sustituyen por los nombres que
   realmente publica esta versión; al desplegar basta con exportar
   RUTA_PORTADA y RUTA_FICHA antes de ensamblar. */
const RUTA_PORTADA = process.env.RUTA_PORTADA || 'portada.dc.html';
const RUTA_FICHA   = process.env.RUTA_FICHA   || 'ficha.dc.html';
const RUTA_RECURSOS = process.env.RUTA_RECURSOS || 'recursos.dc.html';
...
const HELMET = (conMapa) => `<helmet>
  ...
  <link rel="canonical" href="https://sedema.cdmx.gob.mx/arboles-patrimoniales/">
  ...
  <meta property="og:url" content="https://sedema.cdmx.gob.mx/arboles-patrimoniales/">
  ...
  <meta name="twitter:image" content="https://sedema.cdmx.gob.mx/arboles-patrimoniales/assets/img/portada/compartir.jpg">
<link rel="icon" type="image/png" href="data:image/png;base64,">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/PapaParse/5.4.1/papaparse.min.js"><\/script>${conMapa ? `
...
// El script de la lógica NO es JavaScript ordinario: Claude Design lo recoge
// por su tipo. Si se emite como <script> normal, el navegador lo ejecuta antes
// de que exista DCLogic y la página truena con «DCLogic is not defined».
const armar = (salida, cuerpo, logica, conMapa) => {
...
${fs.readFileSync(logica, 'utf8').trim()}
<\/script>
</body>
</html>`;
  fs.writeFileSync(SALIDA + salida, enlazar(html));
  console.log(salida, '·', Math.round(html.length / 1024), 'KB');
};

armar('portada.dc.html', 'dc-cuerpo.html', 'dc-logica.js', true);
// La ficha ahora dibuja el mapa del ejemplar: necesita Leaflet igual que la portada.
armar('ficha.dc.html', 'ficha-dc-cuerpo.html', 'ficha-dc-logica.js', true);
// La página de Recursos es estática: no necesita mapa ni datos.
armar('recursos.dc.html', 'recursos-dc-cuerpo.html', 'recursos-dc-logica.js', false);
