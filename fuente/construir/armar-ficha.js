...
const js=exigir(fs.readFileSync('ficha-logica.js','utf8'),'export function pintarFicha','ficha-logica.js').replace('export function pintarFicha','function pintarFicha').replace(/^import .*geo-cdmx.js";$/m,()=>geo).replace(/^import .*especies.js";$/m,'').replace(/^import .*fotos.js";$/m,'');const esp=';(function(){\n'+fs.readFileSync('especies.js','utf8').replace(/^export const /gm,'const ').replace(/^export function /gm,'function ').replace(/^export /gm,'')+'\nwindow.svgSilueta=svgSilueta;window.svgPersona=svgPersona;window.perfilDe=perfilDe;window.ilustracionDe=ilustracionDe;window.siluetaPlana=siluetaPlana;window.PROPORCION_ILUSTRACION=PROPORCION_ILUSTRACION;window.PERSONA=PERSONA;\n})();';
...
<title>Ficha · Árboles patrimoniales de la Ciudad de México</title>
