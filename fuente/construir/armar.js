...
const ind=envolver('indicadores.js',['indicadoresPadron']);
const dif=envolver('leaflet-diferido.js',['cargarLeaflet','cuandoSeAcerque']);
...
<!-- Leaflet NO se carga aquí: son 145 KB que no sirven hasta llegar al mapa,
     tres pantallas más abajo. Lo descarga leaflet-diferido.js cuando el
     contenedor del mapa se acerca a la pantalla. -->
