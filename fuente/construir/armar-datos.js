...
const DICCIONARIO = {
  ...
  'diametro_cm': ['Diámetro normal (DN) del tronco, medido a 1.30 m del suelo; también llamado DAP.', 'número', 'centímetros', 'Medición de campo'],
  ...
  'extension_copa_m': ['Diámetro promedio de la copa (media del ancho y el largo).', 'número', 'metros', 'Medición de campo'],
