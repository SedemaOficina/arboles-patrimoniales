...
function tarjetaFicha(e) {
  const cats = e.categorias.length
    ? e.categorias.map((c) => {
        ...
        // Mismo simbolo que en el encabezado de la ficha, mas chico: aqui hay
        // tres etiquetas dentro de una tarjeta angosta. Es decorativo —la
        // palabra sigue siendo el nombre de la categoria—.
